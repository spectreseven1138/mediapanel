...
export function value_to_boolean(value: Gjs.byteArray.ByteArray, result: boolean): boolean
export function value_to_ulong(value: Gjs.byteArray.ByteArray, result: number): boolean
...
export class Object {
    ...
    get_data(attr_type: number, cancellable?: Gio.Cancellable | null): Gjs.byteArray.ByteArray
...
export class Session {
    ...
    decrypt(key: Object, mech_type: number, input: Gjs.byteArray.ByteArray, cancellable?: Gio.Cancellable | null): Gjs.byteArray.ByteArray
    decrypt_async(key: Object, mechanism: Mechanism, input: Gjs.byteArray.ByteArray, cancellable?: Gio.Cancellable | null, callback?: Gio.AsyncReadyCallback | null): void
    decrypt_finish(result: Gio.AsyncResult): Gjs.byteArray.ByteArray
    decrypt_full(key: Object, mechanism: Mechanism, input: Gjs.byteArray.ByteArray, cancellable?: Gio.Cancellable | null): Gjs.byteArray.ByteArray
    ...
    encrypt(key: Object, mech_type: number, input: Gjs.byteArray.ByteArray, cancellable?: Gio.Cancellable | null): Gjs.byteArray.ByteArray
    encrypt_async(key: Object, mechanism: Mechanism, input: Gjs.byteArray.ByteArray, cancellable?: Gio.Cancellable | null, callback?: Gio.AsyncReadyCallback | null): void
    encrypt_finish(result: Gio.AsyncResult): Gjs.byteArray.ByteArray
    encrypt_full(key: Object, mechanism: Mechanism, input: Gjs.byteArray.ByteArray, cancellable?: Gio.Cancellable | null): Gjs.byteArray.ByteArray
    ...
    get_slot(): Slot
    get_state(): number
    init_pin(pin: Gjs.byteArray.ByteArray | null, cancellable?: Gio.Cancellable | null): boolean
    init_pin_async(pin: Gjs.byteArray.ByteArray | null, cancellable?: Gio.Cancellable | null, callback?: Gio.AsyncReadyCallback | null): void
    init_pin_finish(result: Gio.AsyncResult): boolean
    login(user_type: number, pin: Gjs.byteArray.ByteArray | null, cancellable?: Gio.Cancellable | null): boolean
    login_async(user_type: number, pin: Gjs.byteArray.ByteArray | null, cancellable?: Gio.Cancellable | null, callback?: Gio.AsyncReadyCallback | null): void
    ...
    set_interaction(interaction?: Gio.TlsInteraction | null): void
    set_pin(old_pin: Gjs.byteArray.ByteArray | null, new_pin: Gjs.byteArray.ByteArray | null, cancellable?: Gio.Cancellable | null): boolean
    set_pin_async(old_pin: Gjs.byteArray.ByteArray | null, n_old_pin: number, new_pin: Gjs.byteArray.ByteArray | null, cancellable?: Gio.Cancellable | null, callback?: Gio.AsyncReadyCallback | null): void
    set_pin_finish(result: Gio.AsyncResult): boolean
    sign(key: Object, mech_type: number, input: Gjs.byteArray.ByteArray, cancellable?: Gio.Cancellable | null): Gjs.byteArray.ByteArray
    sign_async(key: Object, mechanism: Mechanism, input: Gjs.byteArray.ByteArray, cancellable?: Gio.Cancellable | null, callback?: Gio.AsyncReadyCallback | null): void
    sign_finish(result: Gio.AsyncResult): Gjs.byteArray.ByteArray
    sign_full(key: Object, mechanism: Mechanism, input: Gjs.byteArray.ByteArray, n_result: number, cancellable?: Gio.Cancellable | null): number
    unwrap_key(wrapper: Object, mech_type: number, input: Gjs.byteArray.ByteArray, attrs: Attributes, cancellable?: Gio.Cancellable | null): Object
    unwrap_key_async(wrapper: Object, mechanism: Mechanism, input: Gjs.byteArray.ByteArray, attrs: Attributes, cancellable?: Gio.Cancellable | null, callback?: Gio.AsyncReadyCallback | null): void
    unwrap_key_finish(result: Gio.AsyncResult): Object
    unwrap_key_full(wrapper: Object, mechanism: Mechanism, input: Gjs.byteArray.ByteArray, attrs: Attributes, cancellable?: Gio.Cancellable | null): Object
    verify(key: Object, mech_type: number, input: Gjs.byteArray.ByteArray, signature: Gjs.byteArray.ByteArray, cancellable?: Gio.Cancellable | null): boolean
    verify_async(key: Object, mechanism: Mechanism, input: Gjs.byteArray.ByteArray, signature: Gjs.byteArray.ByteArray, cancellable?: Gio.Cancellable | null, callback?: Gio.AsyncReadyCallback | null): void
    verify_finish(result: Gio.AsyncResult): boolean
    verify_full(key: Object, mechanism: Mechanism, input: Gjs.byteArray.ByteArray, signature: Gjs.byteArray.ByteArray, cancellable?: Gio.Cancellable | null): boolean
    wrap_key(wrapper: Object, mech_type: number, wrapped: Object, cancellable?: Gio.Cancellable | null): Gjs.byteArray.ByteArray
    ...
    wrap_key_finish(result: Gio.AsyncResult): Gjs.byteArray.ByteArray
    wrap_key_full(wrapper: Object, mechanism: Mechanism, wrapped: Object, cancellable?: Gio.Cancellable | null): Gjs.byteArray.ByteArray
    /* Methods of GObject.Object */
    bind_property(source_property: string, target: GObject.Object, target_property: string, flags: GObject.BindingFlags): GObject.Binding
    bind_property_full(source_property: string, target: GObject.Object, target_property: string, flags: GObject.BindingFlags, transform_to: GObject.Closure, transform_from: GObject.Closure): GObject.Binding
    force_floating(): void
...
export class Builder {
    ...
    add_data(attr_type: number, value: Gjs.byteArray.ByteArray | null): void
    ...
    set_data(attr_type: number, value: Gjs.byteArray.ByteArray | null): void
    ...
    steal(): Attributes
    take_data(attr_type: number, value: Gjs.byteArray.ByteArray | null): void
    static name: string
...
export abstract class ModuleClass {
    ...
    parent: GObject.ObjectClass
    authenticate_slot: any
    authenticate_object: any
    static name: string
}
