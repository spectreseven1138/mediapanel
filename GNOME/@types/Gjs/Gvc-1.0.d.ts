...
export class MixerControl {
    /* Properties of Gvc.MixerControl */
...
export abstract class MixerControlClass {
    ...
    card_added: any
    card_removed: any
    default_sink_changed: any
    default_source_changed: any
    active_output_update: any
    active_input_update: any
    output_added: any
    input_added: any
    output_removed: any
    input_removed: any
    audio_device_selection_needed: any
    static name: string
}
