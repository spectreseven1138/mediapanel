...
export function fingerprint_from_attributes(attrs: Gck.Attributes, checksum_type: GLib.ChecksumType): Gjs.byteArray.ByteArray | null
export function fingerprint_from_subject_public_key_info(key_info: Gjs.byteArray.ByteArray, checksum_type: GLib.ChecksumType): Gjs.byteArray.ByteArray | null
...
export class Certificate {
    ...
    get_der_data(): Gjs.byteArray.ByteArray
    get_expiry_date(): GLib.Date
    get_fingerprint(type: GLib.ChecksumType): Gjs.byteArray.ByteArray
    ...
    get_issuer_raw(): Gjs.byteArray.ByteArray
    get_key_size(): number
    get_markup_text(): string
    get_serial_number(): Gjs.byteArray.ByteArray
...
export class CertificateRequest {
    /* Properties of Gcr.CertificateRequest */
    /* Fields of GObject.Object */
    g_type_instance: GObject.TypeInstance
    ...
    encode(textual: boolean): Gjs.byteArray.ByteArray
...
export class FilterCollection {
    /* Properties of Gcr.FilterCollection */
...
export class Parser {
    ...
    get_parsed_block(): Gjs.byteArray.ByteArray | null
    get_parsed_bytes(): Gjs.byteArray.ByteArray
    get_parsed_description(): string | null
    get_parsed_format(): DataFormat
    get_parsed_label(): string | null
    parse_bytes(data: Gjs.byteArray.ByteArray): boolean
    parse_data(data: Gjs.byteArray.ByteArray): boolean
...
export class Pkcs11Certificate {
    /* Properties of Gcr.Pkcs11Certificate */
...
export class SecretExchange {
    /* Properties of Gcr.SecretExchange */
    /* Fields of Gcr.SecretExchange */
    /* Fields of GObject.Object */
    g_type_instance: GObject.TypeInstance
...
export class SimpleCertificate {
    ...
    static new(data: Gjs.byteArray.ByteArray): SimpleCertificate
    static $gtype: GObject.Type
}
...
export class SystemPrompter {
    ...
    unref(): void
    watch_closure(closure: GObject.Closure): void
    /* Virtual methods of Gcr.SystemPrompter */
    /* Virtual methods of GObject.Object */
    vfunc_constructed?(): void
    vfunc_dispatch_properties_changed?(n_pspecs: number, pspecs: GObject.ParamSpec): void
    vfunc_dispose?(): void
...
export abstract class Pkcs11CertificateClass {
    /* Fields of Gcr.Pkcs11CertificateClass */
    static name: string
}
...
export abstract class SecretExchangeClass {
    ...
    generate_exchange_key: any
    derive_transport_key: any
    static name: string
}
