...
export function byte_array_steal(array: Gjs.byteArray.ByteArray): [ /* returnType */ number, /* len */ number | null ]
...
export class ByteArray {
    ...
    static steal(array: Gjs.byteArray.ByteArray): [ /* returnType */ number, /* len */ number | null ]
